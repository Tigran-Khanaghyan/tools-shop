...
export default function ToolsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-6">
        <h1 data-qa="tools-shop-title" className="text-2xl font-bold text-gray-900">
          My Tools
        </h1>
      ...
      {filtered.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-xs">
            We couldn't find any tools matching your search. Try different keywords or clear the
            filter.
          </p>
          <button
            onClick={() => {
